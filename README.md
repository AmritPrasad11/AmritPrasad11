...
**Software Development & UI/UX Intern — Protionix Technology**  
*Jul 2024 – Feb 2025*  
- Built scalable web apps using HTML, CSS, JavaScript  
- Designed mobile-first UI/UX using Figma & Adobe XD  
- Integrated APIs with backend teams  
- Delivered production-ready interfaces  
